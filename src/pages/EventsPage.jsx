...
const EventCard = ({ event, editable, pending, onEdit, onDelete, onApprove }) => (
...
const EventsPage = () => {
    ...
    const handleCreateOrUpdate = async () => {
        try {
            const data = { ...formData, aforoMax: Number(formData.aforoMax) };
            if (editingId) {
            ...
            setFormOpen(false);
            setFormData({ titulo: '', descripcion: '', fechaInicio: '', fechaFin: '', lugar: '', aforoMax: '' });
            setEditingId(null);
            await refreshAll();
        } catch (err) {
